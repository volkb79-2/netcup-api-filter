...
from ..config_defaults import load_defaults, require_default
...
def seed_default_entities(
    ...
    Args:
        ...
        seed_demo_clients_flag: Whether to seed multiple demo clients (default False)
    ...
    if seed_demo_clients_flag:
        ...
        logger.info("Seeded default admin user, demo clients, and audit logs")
    else:
        logger.info("Seeded default admin user (demo clients disabled)")
    db.session.commit()
