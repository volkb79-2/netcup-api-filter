...
class ClientModelView(SecureModelView):
    ...
    column_list = ['client_id', 'description', 'realm_type', 'realm_value', 'logs', 'is_active', 'email_notifications_enabled', 'created_at']
    ...
    column_formatters = {
        ...
        'logs': lambda v, c, m, p: Markup(f'<a href="/admin/auditlog/?flt1_4={m.client_id}" class="icon-logs" title="View logs for {m.client_id}">🧾</a>'),
    }
